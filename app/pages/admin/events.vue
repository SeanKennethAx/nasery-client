<template>
	<div
		...
		<h2 class="mt-4 text-lg font-bold text-gray-900">All Events</h2>
		<p class="mt-1 max-w-sm text-sm text-gray-500">A platform-wide view of every event across all organizers. This
