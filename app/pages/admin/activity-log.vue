<template>
	<div
		...
		<h2 class="mt-4 text-lg font-bold text-gray-900">Activity Log</h2>
		<p class="mt-1 max-w-sm text-sm text-gray-500">A full audit trail of organizer and admin actions across NaSeRy.
